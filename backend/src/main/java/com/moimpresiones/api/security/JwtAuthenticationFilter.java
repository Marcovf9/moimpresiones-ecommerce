...
/**
 * Lee el header Authorization: Bearer &lt;token&gt; y, si el token es valido,
 * deja autenticado al usuario para el resto de la peticion.
 */
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void authenticate(String username, HttpServletRequest request) {
        try {
            ...
            // El token es valido pero el usuario ya no existe: la peticion sigue anonima.
            logger.debug("Token de un usuario que ya no existe: " + username);
        }
    }
